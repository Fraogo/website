...
export default function FloatingWhatsApp() {
  // Only renders if a WhatsApp number is configured in content/index.ts
  if (!contact.whatsapp || contact.whatsapp === '[WHATSAPP_NUMBER_DIGITS_ONLY]') return null

  const url = `https://wa.me/${contact.whatsapp}?text=${encodeURIComponent(
    "Hi Fraogo, I'd like to enquire about your services."
  )}`
